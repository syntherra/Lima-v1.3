...
import { GitBranch, Contact } from 'lucide-react';
      ...
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Sales pipeline</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md">
              Visualize your sales pipeline, track deal progress, and optimize your sales process.
            </p>
          </div>
        </div>
      </div>
