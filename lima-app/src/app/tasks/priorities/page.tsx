...
export default function TasksPrioritiesPage() {
  return (
    <DashboardLayout>
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Priorities</h1>
            <p className="text-gray-600 dark:text-gray-400">Task priorities</p>
          </div>
        </div>
