    ...
    <DashboardLayout>
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Overdue</h1>
            <p className="text-gray-600 dark:text-gray-400">Overdue tasks</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex flex-col items-center justify-center h-full text-center">
            <div className="p-4 bg-red-500/10 rounded-full mb-4">
              <ListTodo className="h-12 w-12 text-red-500" />
            </div>
