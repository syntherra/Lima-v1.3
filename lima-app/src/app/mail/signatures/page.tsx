    ...
    <DashboardLayout>
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Signatures</h1>
            <p className="text-gray-600 dark:text-gray-400">Email signatures</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-md">
              Create and manage professional email signatures for your outgoing messages.
            </p>
          </div>
        </div>
      </div>
